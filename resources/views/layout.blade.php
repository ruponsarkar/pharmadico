    ...
    <div class="container-fluid bg-white">
        ...
        <div class="row" style="background-image:url({{url('assets/homeAssets/'.$banner)}}); background-size:cover; background-position: center; min-height:180px">
            <div class="col-md-3 d-flex align-items-center justify-content-center">
                <div class="">
                    <a href="{{url('/')}}" class=" me-auto me-lg-0"><img src="{{url('assets/homeAssets/'.$logo)}}"
                            alt="" class=" logo">
                    </a>
                </div>
            </div>
                    ...
                    <div class="row" data-aos="zoom-in" data-aos-delay="100">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="footer-info">
                                <h3>About Us </h3>
                                <p>
                                Pharmedico Publishers is an open-access, international research based publishing house committed to providing a 'peer reviewed' platform to outstanding researchers and scientists to exhibit their findings for the furtherance of society to provoke debate and provide
